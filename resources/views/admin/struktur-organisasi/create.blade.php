...
@section('title', 'Upload Struktur Organisasi')
@section('page-title', 'Upload Struktur Organisasi')
@section('page-subtitle', 'Upload gambar struktur organisasi sekolah')
        ...
        <form action="{{ route('admin.struktur-organisasi.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                <label class="mb-2 block font-semibold text-gray-700">
                    Gambar Struktur Organisasi <span class="text-red-500">*</span>
                </label>
                ...
                @enderror
                <p class="mt-1 text-sm text-gray-500">Format: JPG, PNG. Maksimal 5MB. Disarankan ukuran landscape/fullwidth.
                </p>
            </div>

            <!-- Preview Gambar -->
            <div id="preview-container" class="mb-6 hidden">
                <label class="mb-2 block font-semibold text-gray-700">Preview:</label>
