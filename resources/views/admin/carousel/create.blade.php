...
@section('page-title', 'Tambah Carousel')
@section('page-subtitle', 'Tambahkan gambar carousel baru')
...
<div class="max-w-3xl">
    ...
    <div class="bg-white rounded-xl shadow-sm">
        <div class="p-6 border-b border-gray-200">
            <h3 class="text-lg font-semibold text-gray-800">Form Tambah Carousel</h3>
            <p class="text-sm text-gray-500 mt-1">Lengkapi form di bawah untuk menambah carousel baru</p>
        </div>

        <form action="{{ route('admin.carousel.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                <div id="imagePreview" class="mt-4 hidden">
                    <img id="preview" src="" alt="Preview" class="max-w-full h-48 object-cover rounded-lg shadow-md mx-auto">
                </div>
            ...
            <div>
                ...
                <textarea id="deskripsi" 
                          ...
                          placeholder="Masukkan deskripsi carousel (opsional)">{{ old('deskripsi') }}</textarea>
