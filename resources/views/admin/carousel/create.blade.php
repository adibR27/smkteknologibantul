    ...
    <div class="max-w-3xl">
        ...
        <div class="rounded-xl bg-white shadow-sm">
            <div class="border-b border-gray-200 p-6">
                ...
                <p class="mt-1 text-sm text-gray-500">Lengkapi form di bawah untuk menambah carousel baru</p>
            </div>
                ...
                <div>
                    ...
                    <div id="imagePreview" class="mt-4 hidden">
                        <img id="preview" src="" alt="Preview"
                            class="mx-auto h-48 max-w-full rounded-lg object-cover shadow-md">
                    </div>
