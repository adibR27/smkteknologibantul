        ...
        <form action="{{ route('admin.artikel.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="datetime-local" name="tanggal_publish"
                            value="{{ old('tanggal_publish', \Carbon\Carbon::now('Asia/Jakarta')->format('Y-m-d\TH:i')) }}"
                            class="w-full rounded-lg border border-gray-300 px-4 py-2.5 transition focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-200">
                    ...
                    <div
                        ...
                        <div class="text-center">
                            <div class="mb-4" id="preview-container" style="display: none;">
                                <img id="image-preview" class="mx-auto max-h-64 rounded-lg" />
                            </div>
                            <i class="fas fa-cloud-upload-alt mb-3 text-4xl text-gray-400" id="upload-icon"></i>
                ...
                <div>
                    ...
                    <textarea name="konten" id="konten" rows="15" placeholder="Tulis konten artikel di sini...">{{ old('konten') }}</textarea>
                    @error('konten')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                    <p class="mt-1 text-sm text-red-600" id="konten-error" style="display: none;">Konten artikel wajib diisi!</p>
                </div>
            </div>
        ...
        tinymce.init({
            ...
            media_url_resolver: function (data, resolve) {
                if (data.url.indexOf('youtube.com') !== -1 || data.url.indexOf('youtu.be') !== -1) {
                    ...
                    if (videoId) {
                        resolve({
                            html: '<iframe width="560" height="315" src="https://www.youtube.com/embed/' + videoId + 
