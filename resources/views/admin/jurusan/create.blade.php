...
@section('page-subtitle', 'Tambah program keahlian baru')
...
@section('content')
    <div class="mx-auto max-w-4xl">
        ...
        <div class="overflow-hidden rounded-xl bg-white shadow-sm">
            ...
            <form action="{{ route('admin.jurusan.store') }}" method="POST" enctype="multipart/form-data" id="jurusanForm"
                class="p-6">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <textarea name="deskripsi" id="deskripsi" class="@error('deskripsi') border-red-500 @enderror">{{ old('deskripsi') }}</textarea>
                    @error('deskripsi')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
